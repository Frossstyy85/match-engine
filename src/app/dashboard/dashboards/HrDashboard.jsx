export default function HrDashboard() {
    return (
        <div className="w-full min-w-0 p-3 sm:p-5 font-sans text-gray-700">
            <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-5 text-gray-900">HR Dashboard</h2>

            <section className="bg-white p-4 sm:p-5 rounded-xl mb-4 sm:mb-5 shadow-sm min-w-0 overflow-hidden">
                <h3 className="text-lg sm:text-xl font-semibold mb-3 text-gray-800">Bemanningsgrad</h3>
            ...
            <section className="bg-white p-4 sm:p-5 rounded-xl mb-4 sm:mb-5 shadow-sm min-w-0 overflow-hidden">
                <h3 className="text-lg sm:text-xl font-semibold mb-3 text-gray-800">Kompetensöversikt</h3>
                <ul className="list-none p-0 m-0">
            ...
            <section className="bg-white p-4 sm:p-5 rounded-xl mb-4 sm:mb-5 shadow-sm min-w-0 overflow-hidden">
                <h3 className="text-lg sm:text-xl font-semibold mb-3 text-gray-800">Matchningsresultat</h3>
