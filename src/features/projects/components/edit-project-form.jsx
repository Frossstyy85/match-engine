...
export default function EditProjectForm({ project, skills, projectSkills = [], teams = [] }) {
  const router = useRouter()
  const anchor = useComboboxAnchor()

  const [name, setName] = React.useState(project.name ?? '')
  const [description, setDescription] = React.useState(project.description ?? '')
  const [startDate, setStartDate] = React.useState(project.startDate ?? undefined)
  ...
  return (
    <div className='space-y-6'>
      ...
      <Field>
        ...
        <Combobox multiple autoHighlight items={allSkillNames} value={selectedSkills} onValueChange={setSelectedSkills}>
